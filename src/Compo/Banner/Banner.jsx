...
const Banner = () => {
    ...
    return (
        <div className="bannerCon" data-aos="fade-in" data-aos-mirror="true" data-aos-duration="3000" >
            <div className="bannerTxt">
                ...
                <div className="txt">
                    <h1 data-aos="zoom-out-left" data-aos-offset="300" data-aos-duration="2000" data-aos-mirror="true"> CRAFTING JOYFUL BEGINNINGS</h1>
                    <p data-aos="fade-up"
